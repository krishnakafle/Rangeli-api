...
from custom_rest_framework_mvt.renderers import BinaryRenderer
from custom_rest_framework_mvt.schemas import MVT_SCHEMA
...
class BaseMVTView(APIView):
    ...
    def _in_operator_check(self, params):

        result = text.endswith('__in')

        variable_list = [x for x in result.split(',')]
        pass
    ...
    def get(self, request, *args, **kwargs):
        ...
        # print(House.objects.filter(**{'houseId__in': ['547090906080','547090105191']}))
...
def mvt_view_factory(model_class, geom_col="geom"):
    ...
    Returns:
        :py:class:`custom_rest_framework_mvt.views.MVTView`:
        A subclass of :py:class:`custom_rest_framework_mvt.views.MVTView` with its geom_col
