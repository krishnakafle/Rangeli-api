"""
Django settings for municipalProfile project.
...
SECRET_KEY = '4k&iel9@v=4-+!*4lgewde#ppsfriosyxw%vly9l5wbsxdf%)h'
...
ROOT_URLCONF = 'municipalProfile.urls'
...
WSGI_APPLICATION = 'municipalProfile.wsgi.application'
